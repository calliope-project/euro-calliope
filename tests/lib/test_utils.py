...
from eurocalliopelib.utils import eu_country_code_to_iso3, convert_country_code
...
@pytest.mark.parametrize('input,alpha3', [
    ("uk", "GBR"),
    ("el", "GRC"),
    ("de", "DEU"),
    ("Germany", "DEU"),
...
@pytest.mark.parametrize('input,alpha2', [
    ("uk", "GB"),
    ("el", "GR"),
    ("de", "DE"),
    ("Germany", "DE"),
