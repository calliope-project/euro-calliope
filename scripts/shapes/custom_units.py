...
def dissolve_nuts3(path_to_disaggregated_units, path_to_output, nuts_year, path_to_nuts_to_regions):
    ...
    locations = (
        nuts_to_regions_df
        .dropna(subset=[nuts_year_string])
        .set_index(nuts_to_regions_df.dropna(subset=[nuts_year_string])[nuts_year_string])
        .id
        .append(
