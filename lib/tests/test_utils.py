...
@pytest.mark.parametrize('input_country,output,iso3166', [
    ("uk", "GBR", "alpha3"),
    ("el", "GRC", "alpha3"),
    ("de", "DEU", "alpha3"),
    ("Germany", "DE", "alpha2"),
...
def test_country_code_conversion(input_country, output, iso3166):
    assert convert_country_code(input_country, output) == iso3166


@pytest.mark.parametrize('input_country,iso3166', [
    ("uk", "GBR"),
    ("el", "GRC"),
    ("de", "DEU"),
    ("Germany", "DEU"),
